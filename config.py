...
# Recommended
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8306749369:AAEpmCjkHwnfvW6d6YEBo2W-UliADdjnct8")
APP_ID = int(os.environ.get("APP_ID", "26944587"))
API_HASH = os.environ.get("API_HASH", "7261a455f2a6159b8a2fbfecd1a63004")

# Main
OWNER_ID = int(os.environ.get("OWNER_ID", "5579479179"))
PORT = os.environ.get("PORT", "8080")

# Database
DB_URI = os.environ.get("DB_URI", "mongodb+srv://kojar29650:h8jvNvpyteVB8AzM@cluster0.uywzxza.mongodb.net/?retryWrites=true&w=majority&appName=flyton")
DB_NAME = os.environ.get("DB_NAME", "flytonp")
...
›› ᴏᴡɴᴇʀ: <a href='https://t.me/ss_godx'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
...
CHANNELS_TXT = """<b>›› ᴀɴɪᴍᴇ ᴄʜᴀɴɴᴇʟ: <a href='https://t.me/FlyTonTV'>ᴀɴɪᴍᴇ</a>
<blockquote expandable>›› ᴍᴏᴠɪᴇs: <a href='https://t.me/FlyTonTV'>ᴍᴏᴠɪᴇ</a>
›› ᴡᴇʙsᴇʀɪᴇs: <a href='https://t.me/FlyTonTV'>ᴡᴇʙsᴇʀɪᴇs</a>
›› ᴀᴅᴜʟᴛ ᴄʜᴀɴɴᴇʟs: <a href='https://t.me/FlyTonTV'>ᴄᴏʀɴʜᴜʙ</a>
›› ᴍᴀɴʜᴡᴀ ᴄʜᴀɴɴᴇʟ: <a href='https://t.me/FlyTonTV'>ᴘᴏʀɴʜᴡᴀ</a>
›› ᴄᴏᴍᴍᴜɴɪᴛʏ: <a href='https://t.me/FlyTonTV'>Flyton</a>
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1003556653759")) # Channel where user links are stored
#--- ---- ---- --- --- --- - -- -  - - - - - - - - - - - --  - -

try:
    ADMINS = []
    for x in (os.environ.get("ADMINS", "5579479179").split()):
        ADMINS.append(int(x))
except ValueError:
