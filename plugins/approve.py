...
async def autoapprove(client, message: ChatJoinRequest):
    ...
    if APPROVED == "on":
        ...
        buttons = [
            ...
            [InlineKeyboardButton(f'• ᴊᴏɪɴ •', url='https://t.me/FlyTonTV')],
            [InlineKeyboardButton(f'• 18+ Network •', url='https://t.me/Soldier_Network')],
            [InlineKeyboardButton(f'• ʙᴀᴄᴋᴜᴘ •', url='https://t.me/FlyTonTV')]
        ]
        ...
        await client.send_photo(
            chat_id=user.id,
            photo='https://i.ibb.co/BHnhz8JD/x.jpg',
            caption=caption,
            reply_markup=markup
        )
